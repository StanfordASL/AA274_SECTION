...
All of the code we write will be located inside of a catkin workspace. To create a new package for our code, run:
...
Note that there is another, older way of building with catkin called \texttt{catkin\_make}, but we will not use it in this class.
