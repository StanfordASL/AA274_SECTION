...
You can also see additional, more comprehensive examples of each library in the CS231N tutorial:

https://cs231n.github.io/python-numpy-tutorial/

\textbf{Checkoff problem: Using the example code, create a new script that does the following:
\begin{enumerate}
	...
	\item Plot the function using Matplotlib.
\end{enumerate}}

Once you have done this, please submit screenshots of your output to:

\href{https://forms.gle/V7rjrRfQJ84cdje29}{https://forms.gle/V7rjrRfQJ84cdje29}
